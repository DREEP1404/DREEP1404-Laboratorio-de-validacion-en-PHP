...
<body>
	...
	<?PHP
		...
		$usuarioData = $db->log($UsuarioID);

		$nombreUsuario = $usuarioData ? $usuarioData->Nombre : 'Invitado';
	?>
...
<div id="content-wrap">
	<div id="main"> 	
				...
				<h1>USUARIO:  <?PHP echo strtoupper($_SESSION['NombreReal']); ?></h1>
				...
				pasen una Feliz Navidad y un Prospero Año Nuevo, unidos a su amada familia.<br>";
